...
public class AdminController {
	...
	public ResponseEntity<String> AddProduct(@RequestBody ProductDTO request,@RequestPart(value="file", required = false) MultipartFile file){
	...
	public ResponseEntity<String> getNotice(@RequestParam int pagenum, @RequestBody NoticeInfo request){
		
		
		return  Utils.responseentity(cms.getMessage(401, "함수 오류", false));
	}
}
